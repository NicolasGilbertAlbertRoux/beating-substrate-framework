...
- **Ouvert pour tous** : magnitudes de Λ (catastrophe levée, valeur ouverte), de G, spectre des masses. **Adoptés** : ℏ (constante mesurée), règle de Born.
...
```
scripts/        stageN_*.py + tool_basin_hopping_clusters.py
reproduce.py
requirements.txt
README.md
LICENSE
CHARTER.md                    ← le journal d'honnêteté, à jour
ARTICLE_substrat_battant.{tex,pdf}   (+ .md si vous voulez la source éditable)
RECUEIL_propositions.{tex,pdf}
SOCLE_ontologique.md
```
